            ...
            <section id="profiles" className={styles['two-col']}>
                <div className={styles['col']}>
                    ...
                    <p className={styles['description']}>
                        ...
                        More information on Henry can be found <Link to="/horses/Henry/about">Here</Link>
                    </p>
                </div>
                <div className={styles['col']}>
                    ...
                    He is currently working with a new mustang, Titus. More information on Titus can be found <Link to="/horses/Titus/about">Here</Link>
                    </p>
                </div>
            </section>
        </div>
